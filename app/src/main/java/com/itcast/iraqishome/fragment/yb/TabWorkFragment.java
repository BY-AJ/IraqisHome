...
public class TabWorkFragment extends BaseFragment{
    ...
    private void initBasic(View view) {
        ...
        //FullyGridLayoutManager headerManager = new FullyGridLayoutManager(mActivity,4,GridLayoutManager.VERTICAL,true);
        ...
        //mRecyclerFront.setNestedScrollingEnabled(false);
    }
